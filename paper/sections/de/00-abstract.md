...
Wir evaluieren fünf modernste LLMs über drei Domänenebenen: (A) hochpräzise technische Fragen mit verifizierbaren Korrektantworten, (B) regulatorische und Compliance-Fragen mit autoritativen Rechtsquellen sowie (C) strategische und architekturelle Fragen mit legitimen Expertenmeinungsverschiedenheiten. Mithilfe semantischer Ähnlichkeitsmetriken (BERTScore, Kosinus-Embedding-Distanz), faktischer Genauigkeit gegen vorregistrierte Korrektantworten und Ausreißererkennung via DBSCAN-Clustering quantifizieren wir die modellübergreifende Abweichung sowie deren Zusammenhang mit Domänentyp und Halluzinationsrate.
